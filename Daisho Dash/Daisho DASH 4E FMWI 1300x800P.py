...
while running:
    ...
    if player.dead == False and Ready == True and BOSS_BATTLE == False and Boss_incoming ==False:
        ...
        if Enemieson == True:
            golden_timer = pygame.time.get_ticks() - now4 - UntilStart- Timervarier
        ...
        ##Teaman spawn Timer
        if Enemieson == True:
            teaman_timer = pygame.time.get_ticks() - now6 - UntilStart- Timervarier
        ...
        if Enemieson == True:
            barondown_timer = pygame.time.get_ticks() - now7 - UntilStart - Timervarier
        ...
        if Enemieson == True and Ready == True and pygame.time.get_ticks()>UntilStart+3000:
            spectre_timer = pygame.time.get_ticks() - now5 - UntilStart - Timervarier
